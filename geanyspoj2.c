...
PLUGIN_SET_TRANSLATABLE_INFO("SPOJ Submissions", "Tool to submit spoj problem submissions from geany itself!",
...
{
	gchar user_ent[30],pwd_ent[30],probid_ent[30];
int active_choice;
...
if(!soln_doc)
{
gchar *doc_fn, *user_ent, *pwd_end, *probid_ent,*lang;
