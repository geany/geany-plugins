...
#define GEANY_MACRO_BUTTON_CANCEL	1
#define GEANY_MACRO_BUTTON_DELETE	2
#define GEANY_MACRO_BUTTON_EDIT		3
#define GEANY_MACRO_BUTTON_RERECORD	4
#define GEANY_MACRO_BUTTON_UP			5
#define GEANY_MACRO_BUTTON_DOWN		6
#define GEANY_MACRO_BUTTON_ABOVE	7
#define GEANY_MACRO_BUTTON_BELOW	8
#define GEANY_MACRO_BUTTON_APPLY	9
